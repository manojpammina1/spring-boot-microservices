...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler  {
  ...
  public final ResponseEntity<Object> handelResourceNotFoundException(NoSuchElementException ex, WebRequest request) {
  ...
  public final ResponseEntity<Object> handleNoSuchElementException(Exception ex, WebRequest request) {
    ...
    ProblemDetail pd = ProblemDetail.forStatusAndDetail(HttpStatus.INSUFFICIENT_STORAGE, ex.getMessage());
    return createResponseEntity(pd, null, HttpStatus.NOT_FOUND, request);
  }
}
